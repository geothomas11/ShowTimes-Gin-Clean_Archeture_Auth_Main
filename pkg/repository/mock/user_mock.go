...
func (m *MockUserRepository) AddAddress(userID int, address models.AddressInfoResponse) (models.AddressInfoResponse, error) {
	m.ctrl.T.Helper()
...
// CheckUserAvialiablity mocks base method.
func (m *MockUserRepository) CheckUserAvialiablity(email string) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckUserAvialiablity", email)
	ret0, _ := ret[0].(bool)
	return ret0
}

// CheckUserAvialiablity indicates an expected call of CheckUserAvialiablity.
func (mr *MockUserRepositoryMockRecorder) CheckUserAvialiablity(email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckUserAvialiablity", reflect.TypeOf((*MockUserRepository)(nil).CheckUserAvialiablity), email)
}
